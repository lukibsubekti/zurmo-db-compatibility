    ...
    class DatabaseCompatibilityUtil
    {
        ...
        */
                                                           ...
                                                           $databasePort)
        {
            ...
            {
                case 'mysql':
                    $connection = @mysqli_connect($databaseHostname, $databaseUsername, $databasePassword, $databaseName, $databasePort);
                                                   ...
                                                   $databaseName)
        {
            ...
            switch ($databaseType)
            {
                case 'mysql':
                    $result = true;
                    if (($connection = @mysqli_connect($host, $rootUsername, $rootPassword, $databaseName, $port)) === false )
                    {
                        $result = array(mysqli_errno($connection), mysqli_error($connection));
                    }
                    if (is_resource($connection))
